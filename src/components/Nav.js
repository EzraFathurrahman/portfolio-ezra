...
const Nav = () => {
  ...
  <div className='container mx-auto'>
    <div className="w-full bg-black/20 h-[84px] backdrop-blur-2xl rounded-full max-w-[320px] mx-auto px-1 flex justify-around text-2xl text-white/50 items-center">
